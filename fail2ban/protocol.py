...
["set <JAIL> usedns6 <VALUE>", "sets the usedns6 mode for <JAIL>"],
["set <JAIL> removeport <VALUE>", "sets the removeport option for <JAIL>"],
...
["get <JAIL> removeport", "gets the removeport setting for <JAIL>"],
